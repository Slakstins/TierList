...
exec "$JAVA" -d64 $JAVA_OPTS \
    ...
    -Dorientdb.build.number="2.2.x@ra7541e7ceeabf592dd9a7b2928b6c023cbc73193; 2018-09-14 06:09:41+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-2.2.37.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
